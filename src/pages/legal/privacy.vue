...
import { PRIVACY_PARAGRAPHS, PRIVACY_TITLE } from '@/common/legal/privacy'
...
<template>
  <SoorakChrome :title="PRIVACY_TITLE" show-back>
    <SoorakLegalDoc
      :doc-type="LEGAL_DOC_TYPE.PRIVACY"
      :fallback-title="PRIVACY_TITLE"
      :fallback-paragraphs="PRIVACY_PARAGRAPHS"
    />
  </SoorakChrome>
</template>
